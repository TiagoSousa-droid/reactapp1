...
function Formulario() {
    ...
    function limparFormulario() {
        setFormData({ nome: '', email: '', telefone: '', morada: '', mensagem: '', codigo: '' });
        ...
        <div className="mt-4 row">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" value={formData.codigo} onChange={(e) =>

                        setFormData({ ...formData, codigo: e.target.value })} required />
                </div>
                <div className="form-group">
            ...
            {dadosSubmetidos && (
                <div className="card mt-4">
                    <div className="card-body">
                        ...
                        <p><strong>Codigo Postal:</strong> {dadosSubmetidos.codigo}</p>
